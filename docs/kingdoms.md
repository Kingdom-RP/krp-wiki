...
!!! warning "Требования к будущему королю"
    ...
    - имеет ещё **два навыка 5+ уровня** (навык из первого условия не учитывается);
...
| **Довольствие** | самоцветы (`#c:gems`) и слитки (`#c:ingots`) | изумруд 1, алмаз 3, прочие самоцветы 0.5; медь 0.3, железо 0.5, золото 1, незеритовый слиток 50 |
...
| Довольствие | `средний уровень жителя × 0.0926` | 0.0926 за уровень |

Где:

- **жители** — число участников королевства;
- **чанки** — размер территории (число заклеймленных чанков, старт 25);
- **средний уровень жителя** — сумма всех уровней навыков всех жителей ÷ число жителей.

Пример расхода для нового королевства (3 жителя, 25 чанков, средний уровень ≈ 25):

- Продовольствие: `3 × 0.77 = 2.31` за период;
- Материалы: `25 × 0.093 = 2.33` за период;
- Довольствие: `25 × 0.0926 = 2.31` за период.
